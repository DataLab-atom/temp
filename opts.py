...
def parse_args():
    ...
    parser.add_argument('--drop_out', type=float, default=0, help="dopr in net")
    ...
    parser.add_argument('--train_model', type=str, default="mgda", help="swl, mgda")
    parser.add_argument('--weight_grad_modle', type=str, default="norm", help="norm, mean")
    parser.add_argument('--mgda_model', type=str, default="loss+", help="loss, loss+, l2")
    ...
    parser.add_argument('--attion_loss',type=str2bool,default=False)
...
def get_model(args):
    ...
    def model_func1(num_features, num_classes):
        return GCNNet(num_features, num_classes, args.hidden,dropout = args.drop_out)  

    def model_func2(num_features, num_classes):
        return GINNet(num_features, num_classes, args.hidden,dropout = args.drop_out) 
    
    def model_func3(num_features, num_classes):
        return GATNet(num_features, num_classes, args.hidden,dropout = args.drop_out) 
