...
from dir_dataset import DIRDATASET
...
def get_dir_dataset(args):
    args.feature_dim = 5
    args.num_classes = 10
    train_data = DIRDATASET(name = args.dataset,b = args.bias,mode='train')
    test_data = DIRDATASET(name = args.dataset,b = args.bias,mode='test')
    train_data,val_data = train_data[:20000],train_data[-5000:]
